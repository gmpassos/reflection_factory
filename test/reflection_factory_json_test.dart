...
void main() {
  ...
  group('JSON', () {
    test('castListType', () {
      ...
      expect(
        castListType<String>(<String>['a', 'b'], String),
        isA<List<String>>(),
      );
      ...
      expect(
        castListType(<dynamic>[DateTime.now()], DateTime),
        isA<List<DateTime>>(),
      );
      expect(
        castListType(<dynamic>[Duration(hours: -3)], Duration),
        isA<List<Duration>>(),
      );
      expect(
        castListType(<dynamic>[BigInt.from(123)], BigInt),
        isA<List<BigInt>>(),
      );
      expect(
        castListType(<dynamic>[Uint8List(10)], Uint8List),
        isA<List<Uint8List>>(),
      );
    });
    ...
    test('castMapType', () {
      ...
      expect(
        castMapType<String, String>(<String, String>{'a': 'b'}, String, String),
        isA<Map<String, String>>(),
      );
      expect(
        castMapType(<dynamic, dynamic>{'a': 'b'}, String, String),
        isA<Map<String, String>>(),
      );
      expect(
        castMapType(<dynamic, dynamic>{'a': 1}, String, int),
        isA<Map<String, int>>(),
      );
      expect(
        castMapType(<dynamic, dynamic>{'a': 1.2}, String, double),
        isA<Map<String, double>>(),
      );
      expect(
        castMapType(<dynamic, dynamic>{'a': 1.2, 'b': 2}, String, num),
        isA<Map<String, num>>(),
      );
      expect(
        castMapType(<dynamic, dynamic>{'a': true}, String, bool),
        isA<Map<String, bool>>(),
      );

      expect(
        castMapType(<dynamic, dynamic>{'a': DateTime.now()}, String, DateTime),
        isA<Map<String, DateTime>>(),
      );

      expect(
        castMapType(
          <dynamic, dynamic>{'a': Duration(hours: 4)},
          String,
          Duration,
        ),
      ...
      expect(
        castMapType(<dynamic, dynamic>{'a': BigInt.zero}, String, BigInt),
        isA<Map<String, BigInt>>(),
      );
      expect(
        castMapType(<dynamic, dynamic>{'a': Uint8List(10)}, String, Uint8List),
        isA<Map<String, Uint8List>>(),
      );

      expect(
        castMapType<int, String>(<int, String>{1: 'b'}, int, String),
        isA<Map<int, String>>(),
      );

      expect(
        castMapType(<dynamic, dynamic>{1: 'b'}, int, String),
        isA<Map<int, String>>(),
      );
      expect(
        castMapType(<dynamic, dynamic>{1.2: 'b'}, double, String),
        isA<Map<double, String>>(),
      );
      expect(
        castMapType(<dynamic, dynamic>{1.2: 'b', 1: 'a'}, num, String),
        isA<Map<num, String>>(),
      );
      expect(
        castMapType(<dynamic, dynamic>{true: 'b'}, bool, String),
        isA<Map<bool, String>>(),
      );

      expect(
        castMapType(<dynamic, dynamic>{DateTime.now(): 'b'}, DateTime, String),
        isA<Map<DateTime, String>>(),
      );

      expect(
        castMapType(
          <dynamic, dynamic>{Duration(minutes: 1): 'b'},
          Duration,
          String,
        ),
      ...
      expect(
        castMapType(<dynamic, dynamic>{BigInt.zero: 'b'}, BigInt, String),
        isA<Map<BigInt, String>>(),
      );
      expect(
        castMapType(<dynamic, dynamic>{Uint8List(10): 'b'}, Uint8List, String),
        isA<Map<Uint8List, String>>(),
      );

      expect(
        castMapType(<dynamic, dynamic>{'a': 1}, String, dynamic),
        isA<Map<String, dynamic>>(),
      );

      expect(
        castMapType(<dynamic, dynamic>{'a': 1}, String, Object),
        isA<Map<String, Object>>(),
      );

      expect(
        castMapType(<dynamic, dynamic>{}, String, dynamic),
        isA<Map<String, dynamic>>(),
      );

      expect(
        castMapType(<dynamic, dynamic>{}, String, Object),
        isA<Map<String, Object>>(),
      );
  ...
  group('JsonCodec', () {
    ...
    test('toJson', () async {
      ...
      expect(
        JsonCodec().toJson(DateTime.utc(2021, 1, 2, 3, 4, 5)),
      ...
      expect(
        JsonCodec().toJson(Duration(hours: -3)),
        equals(-(3 * 60 * 60 * 1000)),
      );
      ...
      expect(
        JsonCodec().toJson({'a': 1, 'b': 2, 'foo': Foo(51, 'x')}),
      ...
      expect(
        JsonCodec(
          removeField: (k) => k == 'city',
        ).toJson(TestAddressWithReflection.withCity('LA', city: 'Los Angeles')),
        equals({'state': 'LA'}),
      );
      ...
      expect(
        TestAddressWithReflection$reflection.staticInstance.castCollection(
          <dynamic>[123, 456],
          TypeInfo.fromType(Iterable, [int]),
        ),
        isA<Iterable<int>>(),
      );
      ...
      expect(
        JsonCodec().toJson(TestOpAWithReflection(10)),
        equals({'type': 'a', 'value': 10}),
      );

      expect(
        TestOpAWithReflection$reflection.staticInstance.callCasted(<T>(c) => T),
        equals(TestOpAWithReflection),
      );

      expect(
        TestEnumWithReflection$reflection.staticInstance.callCasted(
          <T>(c) => T,
        ),
    ...
    test('fromJson', () async {
      ...
      expect(
        JsonCodec().fromJson('2020-01-02 10:11:12.000Z', type: DateTime),
        equals(DateTime.utc(2020, 1, 2, 10, 11, 12)),
      );

      expect(
        JsonCodec().fromJson('4:20:10:303', type: Duration),
        equals(Duration(hours: 4, minutes: 20, seconds: 10, milliseconds: 303)),
      );
      ...
      expect(
        ...
        equals(TestAddressWithReflection.withCity('LA', city: 'Los Angeles')),
      );
      ...
      expect(
        ...
        equals(
          TestFranchiseWithReflection('FooFranchise', {
      ...
      expect(
        JsonCodec.defaultCodec.fromJsonList([
          'x',
          'z',
        ], type: TestEnumWithReflection),
        allOf(
          equals([TestEnumWithReflection.x, TestEnumWithReflection.z]),
      ...
      expect(
        ...
        equals(
          TestDataWithReflection(
            ...
            domain: TestDomainWithReflection('foo', 'com'),
            id: BigInt.two,
          ),
        ),
      );
      ...
      expect(
        ...
        equals(
          TestDataWithReflection(
            'file',
            Uint8List.fromList(utf8.encode('Hello Plain!')),
            id: BigInt.two,
          ),
        ),
      );
      ...
      expect(
        ...
        equals(
          TestDataWithReflection(
            'file',
            Uint8List.fromList(utf8.encode('Hello Hex!')),
            id: BigInt.two,
          ),
        ),
      );
      ...
      expect(
        ...
        equals(
          TestDataWithReflection(
            'file',
            Uint8List.fromList(utf8.encode('Hello Base64!')),
            id: BigInt.two,
          ),
        ),
      );
    ...
    test('fromJsonMap', () async {
      ...
      var map1 = JsonCodec().fromJsonMap<Map<int, Duration>>(
        jMap1,
        typeInfo: typeInfo1,
      );
      ...
      var map1Async = await JsonCodec().fromJsonMapAsync<Map<int, Duration>>(
        jMap1,
        typeInfo: typeInfo1,
      );
      ...
      var map2 = JsonCodec().fromJsonMap<Map<String, Duration>>(
        jMap1,
        typeInfo: typeInfo2,
      );
      ...
      var map2Async = await JsonCodec().fromJsonMapAsync<Map<String, Duration>>(
        jMap1,
        typeInfo: typeInfo2,
      );
      ...
      var map3 = JsonCodec().fromJsonMap<Map<int, dynamic>>(
        jMap1,
        typeInfo: typeInfo3,
      );
      ...
      var map3Async = await JsonCodec().fromJsonMapAsync<Map<int, dynamic>>(
        jMap1,
        typeInfo: typeInfo3,
      );
      ...
      var map4 = JsonCodec().fromJsonMap<Map<String, dynamic>>(
        jMap1,
        typeInfo: typeInfo4,
      );
      ...
      var map4Async = await JsonCodec().fromJsonMapAsync<Map<String, dynamic>>(
        jMap1,
        typeInfo: typeInfo4,
      );
      ...
      var objMap = {
        'a': TestAddressWithReflection.withCity(
          'NY',
          city: 'New York',
          id: 101,
        ),
        'b': TestAddressWithReflection.withCity(
          'CA',
          city: 'Los Angeles',
          id: 201,
        ),
      ...
      var map5 = JsonCodec()
          .fromJsonMap<Map<String, TestAddressWithReflection>>(
            jMap2,
            typeInfo: typeInfo5,
          );
      ...
      var map6 = JsonCodec().fromJsonMap<Map<String, dynamic>>(
        jMap2,
        typeInfo: typeInfo6,
      );
    ...
    test('encode', () async {
      ...
      expect(
        JsonEncoder.defaultEncoder.convert({'a': 1, 'b': 2}),
        equals('{"a":1,"b":2}'),
      );
...

      {
        ...
        var json = jsonCodec.encode({
          'x': 123,
          'date': DateTime.utc(2021, 10, 11, 20, 21, 22),
        });

        expect(
          json,
          equals('{"x":123,"date":"date:2021-10-11 20:21:22.000Z"}'),
        );
    ...
    test('decode', () async {
      ...
      expect(
        JsonDecoder.defaultDecoder.convert('{"a":1,"b":2}'),
        equals({'a': 1, 'b': 2}),
      );

      expect(
        await jsonCodec.decodeAsync<Map>(Future.value('{"a":1,"b":2}')),
        equals({'a': 1, 'b': 2}),
      );
            ...
            return map.map((key, value) {
              switch (key) {
                case 'ab':
                  return MapEntry(
                    key,
                    AB.fromMap(value as Map<String, dynamic>),
                  );
                default:
          ...
          jsomMapDecoderAsyncProvider: (type, map, j) {
            ...
            return (m, j) {
              ...
              m = m.map(
                (key, value) => MapEntry(
                  key,
                  key != 'id' ? value.toString().toUpperCase() : value,
                ),
              );
              return classReflection.createInstanceFromMap(m);
            };
    ...
    test('encode/decode', () {
      ...
      expect(
        () => jsonCodec.decode(json1, type: Time),
      ...
      expect(
        () => jsonCodec.decode(json2, type: Time),
    ...
    test('encodeToBytes/decodeFromBytes', () async {
      ...
      var jsonBytes2 = JsonCodec().encodeToBytes({
        'a': 1,
        'b': 2,
      }, pretty: true);
      ...
      expect(
        await JsonCodec().decodeFromBytesAsync(Future.value(jsonBytes2)),
        equals({'a': 1, 'b': 2}),
      );
    });
    ...
    test('entity TestUserWithReflection', () async {
...

      {
        ...
        expect(
          jsonCodec.encode(decodedUser1b),
      ...
      {
        var encodedJson = jsonCodec.encode([
          user1,
          user1,
    ...
    test('encode/decode 2', () {
...

      {
        ...
        expect(
          addressJson,
          equals({'id': 11, 'state': 'NY', 'city': 'New York'}),
        );

        expect(
          JsonCodec.defaultCodec.fromJson(
            addressJson,
            type: TestAddressWithReflection,
          ),
          equals(address),
...

      {
        ...
        try {
          {
            var mainAddress = TestAddressWithReflection.withCity(
              'NY',
              city: 'New York',
              id: 11,
            );
...

          {
            ...
            expect(
              ...
              equals(
                TestCompanyWithReflection(
                  'c1',
                  TestAddressWithReflection.withCity('?', city: '?'),
                ),
              ),
            );
          }
    ...
    test('entity TestTransactionWithReflection', () async {
...

      {
...

        {
          ...
          expect(
            jsonCodec.encode(decoded, duplicatedEntitiesAsID: true),
            equals(encodedJson),
          );
        }
...

        {
          ...
          expect(
            ...
            throwsA(
              isA<UnresolvedParameterError>().having(
                (e) => e.message,
                'message',
      ...
      var jsonDecoder = JsonDecoder(
        jsomMapDecoderProvider: (t, m, j) {
          if (t == TestAddressWithReflection) {
            return (m, j) {
              return TestAddressWithReflection.withCity(
                m['state'] as String,
  ...
  group('JsonEntityCacheSimple', () {
    test('basic', () {
      ...
      jsonEntityCache3.removeCachedEntity(
        mainAddress1?.id,
        type: TestAddressWithReflection,
      );
    ...
    test('cacheEntityInstantiator', () {
      ...
      expect(
        jsonEntityCache2.isCachedEntityByID(
          10,
          type: TestAddressWithReflection,
        ),
        isFalse,
      ...
      expect(
        jsonEntityCache2.getCachedEntityByID(
          10,
          type: TestAddressWithReflection,
        ),
        isNull,
      ...
      expect(
        jsonEntityCache2
            .getCachedEntityByID<TestAddressWithReflection>(
              12,
              instantiate: false,
            )
            ?.id,
